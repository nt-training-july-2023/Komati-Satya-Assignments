...
const AddAssertionQuestion = () => {
        ...
        if (question) {
            QuestionsApi.getByQuestion(question)
                .then((response) => {
                    ...
                    const { question, option1, option2, correctOption, questionId, quizId } = questionInformation;
                    setQuestionData({
                        question,
                        option1,
                        option2,
    ...
    const addQuestionData = async (e) => {
        if (question) {
            showErrors(e)
            setErrors({});
            QuestionsApi.updateAssertionQuestion(questionData.questionId, questionData)
                .then((response) => {
            ...
            showErrors(e)
            setErrors({});
            QuestionsApi.addAssertionQuestion(questionData).then(response => {
...
export default AddAssertionQuestion;